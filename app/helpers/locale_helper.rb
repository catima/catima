module LocaleHelper
  ...
  def locale_form_group(form, method, builder_method, *args)
    ...
    group_label[:text] = options[:label] # to prevent hidden label pass nil options because bootstrap_form 4.x required options even if nil (https://github.com/bootstrap-ruby/bootstrap_form/blob/5ab399b93c5ee454ebdf1c1328e899ec636e9668/lib/bootstrap_form/components/labels.rb#L11)
