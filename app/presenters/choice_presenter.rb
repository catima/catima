class ChoicePresenter
  ...
  def dates
    ...
    from_repr = I18n.t('catalog_admin.fields.complex_datation.bc', date: from_repr) if @choice.choice_set.allow_bc && JSON.parse(@choice.from_date)['BC']
    to_repr = I18n.t('catalog_admin.fields.complex_datation.bc', date: to_repr) if @choice.choice_set.allow_bc && JSON.parse(@choice.to_date)['BC']
