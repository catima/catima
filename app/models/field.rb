...
# Indexes
#
#  index_fields_on_category_item_type_id  (category_item_type_id)
#  index_fields_on_choice_set_id          (choice_set_id)
#  index_fields_on_field_set_id           (field_set_id)
#  index_fields_on_field_set_id_and_slug  (field_set_id,slug) UNIQUE
#  index_fields_on_related_item_type_id   (related_item_type_id)
#
# Foreign Keys
#
#  fk_rails_...  (category_item_type_id => item_types.id)
#  fk_rails_...  (choice_set_id => choice_sets.id)
#  fk_rails_...  (related_item_type_id => item_types.id)
#
