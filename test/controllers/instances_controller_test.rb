...
class InstancesControllerTest < ActionController::TestCase
  ...
  test "should create instance" do
    assert_difference('Instance.count') do
      post :create, instance: { description: @instance.description, name: @instance.name, url: @instance.url }
    end
  ...
  test "should update instance" do
    patch :update, id: @instance, instance: { description: @instance.description, name: @instance.name, url: @instance.url }
    assert_redirected_to instance_path(assigns(:instance))
  end
